...
#define PF8     GPIOF,(uint8_t)8
#define PF9     GPIOF,(uint8_t)9
#define PF10    GPIOF,(uint8_t)10
#define PF11    GPIOF,(uint8_t)11
#define PF12    GPIOF,(uint8_t)12
#define PF13    GPIOF,(uint8_t)13
#define PF14    GPIOF,(uint8_t)14
#define PF15    GPIOF,(uint8_t)15
...
#define PG8     GPIOG,(uint8_t)8
#define PG9     GPIOG,(uint8_t)9
#define PG10    GPIOG,(uint8_t)10
#define PG11    GPIOG,(uint8_t)11
#define PG12    GPIOG,(uint8_t)12
#define PG13    GPIOG,(uint8_t)13
#define PG14    GPIOG,(uint8_t)14
#define PG15    GPIOG,(uint8_t)15

#define PH0     GPIOH,(uint8_t)0
#define PH1     GPIOH,(uint8_t)1
#define PH2     GPIOH,(uint8_t)2
#define PH3     GPIOH,(uint8_t)3
#define PH4     GPIOH,(uint8_t)4
#define PH5     GPIOH,(uint8_t)5
#define PH6     GPIOH,(uint8_t)6
#define PH7     GPIOH,(uint8_t)7
#define PH8     GPIOH,(uint8_t)8
#define PH9     GPIOH,(uint8_t)9
#define PH10    GPIOH,(uint8_t)10
#define PH11    GPIOH,(uint8_t)11
#define PH12    GPIOH,(uint8_t)12
#define PH13    GPIOH,(uint8_t)13
#define PH14    GPIOH,(uint8_t)14
#define PH15    GPIOH,(uint8_t)15

#define PI0     GPIOI,(uint8_t)0
#define PI1     GPIOI,(uint8_t)1
#define PI2     GPIOI,(uint8_t)2
#define PI3     GPIOI,(uint8_t)3
#define PI4     GPIOI,(uint8_t)4
#define PI5     GPIOI,(uint8_t)5
#define PI6     GPIOI,(uint8_t)6
#define PI7     GPIOI,(uint8_t)7
#define PI8     GPIOI,(uint8_t)8
#define PI9     GPIOI,(uint8_t)9
#define PI10    GPIOI,(uint8_t)10
